			...
			<div class="flex w-full justify-between">
				<div class="flex flex flex-col sm:flex-row w-full justify-between gap-20">
					...
					<div id="logo" class="flex sm:block justify-center flex-1">
						<img src="/images/belk-logo-full-edit.svg" alt="Jay Lott Roofing Inc." class="w-52 h-auto" />
					</div>
					...
					<div id="services" class="flex flex-nowrap shrink-0 justify-between gap-8">
						...
						<div class="space-y-6">
							...
							<!-- <div class="flex flex-wrap gap-3">
								<a href="#">
									<img class="w-6 h-6" src="/images/jay-lott-facebook.svg" />
								</a>
								<a href="#">
									<img class="w-6 h-6" src="/images/jay-lott-youtube.svg" />
								</a>
								<a href="#">
									<img class="w-6 h-6" src="/images/jay-lott-vertical-line.svg" />
								</a>
								<a href="#">
									<img class="w-6 h-6" src="/images/jay-lott-google.svg" />
								</a>
								<a href="#">
									<img class="w-6 h-6" src="/images/jay-lott-bbb.svg" />
								</a>
								<a href="#">
									<img class="w-6 h-6" src="/images/jay-lott-yelp.svg" />
								</a>
							</div> -->
						</div>
					</div>
...
<script>
import CallUs from './pages/call-us.vue'
