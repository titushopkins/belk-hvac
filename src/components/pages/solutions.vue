  ...
  <div class="relative z-10 mx-auto w-full max-w-7xl px-6 sm:px-10 lg:px-24">
    <div class="flex items-center justify-between gap-6">
      <h2 class="font-lobster font-semibold italic text-2xl sm:text-4xl leading-tight text-white">
        Roofing solutions that fit any style.
      </h2>
    ...
    >
      ...
      <!-- LEFT ARROW (outside overflow-hidden, offset to screen edge on mobile) -->
       <div class="sm:bg-black w-20 h-12 sm:rounded-full absolute left-0 top-1/2 -translate-y-1/2 z-20
               -ml-12 sm:-ml-8
      ...
      <div class="sm:bg-black w-20 h-12 sm:rounded-full absolute right-0 top-1/2 -translate-y-1/2 z-20
               -mr-12 sm:-mr-8
                flex items-center justify-center text-white
                sm:pointer-events-none
               sm:group-hover:opacity-100 sm:group-hover:pointer-events-auto
    ...
    <div class="mt-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
      <p class="text-lg sm:text-2xl font-semibold leading-tight text-white max-w-2xl">
        Transform your home with a new roof—get started today!
      </p>

      <div class="flex items-center gap-2">
        <RoofingButton href="/gallery" class="px-4 py-3" variant="tertiary" text="View Full Gallery" />
        <RoofingButton href="/contact" class="px-4 py-3" variant="primary" text="Request a Free Quote" />
      </div>
    </div>
  </div>
</section>
...
export default {
  props: {
    buttonText: { type: String, default: 'Request a Free Quote' },
