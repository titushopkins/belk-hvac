  ...
  <main class="w-full bg-gray-900">
    ...
    <section class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
      ...
      <div class="space-y-6">
        ...
        <p>
          At <span class="font-semibold">Jay Lott Roofing,</span> our craftsmanship goes well beyond the roof. We offer
          <span class="font-semibold">professional interior remodeling services</span> designed to improve the comfort, function, and value of your home.
          Whether you’re updating a single room or refreshing your entire interior, our team brings the same attention to detail and commitment to quality that built our reputation.
        </p>

        <p>
          From planning to final walkthrough, we focus on <span class="font-semibold">clear communication, clean job sites,</span> and <span class="font-semibold">results you can be proud of.</span>
        </p>
        ...
        <p>
          If you’re planning an interior remodel, call today to schedule a free estimate. We’ll help you create a space that looks better, functions better, and feels like home.
        </p>
      ...
      <div class="mt-14 space-y-6">
        ...
        <p>
          At <span class="font-semibold">Jay Lott Roofing,</span> we help homeowners protect, enhance, and expand their homes with
          <span class="font-semibold">professional exterior construction services.</span> From durable metal structures to custom outdoor living spaces, our team delivers quality craftsmanship built to stand up to Texas weather.
        </p>

        <p>
          Every exterior project is completed with the same standards we’re known for—<span class="font-semibold">strong materials, skilled installation, clean job sites,</span> and <span class="font-semibold">clear communication</span> from start to finish.
        </p>
        ...
        <p>
          If you’re planning an exterior construction project, call today to schedule a free estimate. We’ll help you improve the look, function, and durability of your home—with results you can trust.
        </p>
